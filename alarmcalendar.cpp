...
#ifdef USE_AKONADI
		updateKAEvents(Collection(), calendar);
#else
...
#ifdef USE_AKONADI
void AlarmCalendar::updateKAEvents(const Collection& collection, KCal::CalendarLocal* cal)
#else
...
#endif
{
	...
	Event* kcalEvent = (mCalType == RESOURCES) ? (Event*)0 : new Event;
