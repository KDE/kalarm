	...
	: PrefsTabBase(frame)
{
	...
	grid->addMultiCellWidget(mDefaultSound, 1, 1, 0, 2, Qt::AlignLeft);
	...
	grid->addMultiCellWidget(mDefaultBeep, 2, 2, 1, 2, Qt::AlignLeft);
	...
	grid->addWidget(mDefaultSoundRepeat, 4, 2, Qt::AlignLeft);
#ifdef WITHOUT_ARTS
